def sbox1(input_bits):
    """
    Implements the S-box 1 from the DES algorithm.

    Args:
        input_bits: A list of 6 bits representing the input to the S-box.

    Returns:
        A list of 4 bits representing the output of the S-box.
    """
